...
def predict_day(forecast_day=1):
    ...
    model = load_encrypted("data_model/pv_model.joblib.enc")
    feature_cols = load_encrypted("data_model/feature_columns.joblib.enc")
